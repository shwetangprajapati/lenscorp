        ...
        <footer className="pt-8 text-center sm:text-inherit">
            <div className="sm:flex sm:items-start sm:justify-between sm:px-24 pb-12">
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <p className="max-w-xs text-black">Tomorrow&lsquo;s Vision, Today!</p>
                ...
                {sitemap.map((category, index) => (
                    <div key={index}>
                        <p className="font-semibold text-base text-black py-8 sm:py-0">
                            {category.title}
                        </p>
                        <ul className="mt-6 space-y-4 text-sm">
                            {category.links.map((link, i) => (
                                <li key={i}>
                                    <a
                                        href={link.url}
                                        className=" text-black transition hover:opacity-75 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-blue-500 hover:to-teal-300 hover:font-semibold"
                                    >
                                        {link.name}
                                    </a>
                                </li>
            ...
            <div className="md:flex items-center justify-between bg-[#272e5c] text-white py-8  sm:px-24">
